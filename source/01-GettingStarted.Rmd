...
# the expression matrix into an set of files in the dir specified: 
write_matrix_dir(mat = geo_mat, dir = 'inputs/10x_mat_filtered')
list_files('inputs/10x_mat_filtered')
# [1] "col_names"         "idxptr"            "index_data"        "index_idx"         "index_idx_offsets" "index_starts"    # [7] "row_names"         "shape"             "storage_order"     "val"               "version" 
geo_mat = open_matrix_dir(dir = 'inputs/10x_mat_filtered')
geo_so = CreateSeuratObject(counts = geo_mat, min.cells = 1, min.features = 50)
geo_so
