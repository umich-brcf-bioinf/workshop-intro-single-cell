...
> #### Good scripting practices {.unlisted .unnumbered}
> 
...
The `inputs/` folder has the data for the workshop stored in two forms. The first, `inputs/10x_analysis/` is closer to what AGC would generate with Cell Ranger, where each sample has a folder, and within that folder there are three files:
...
<!-- Add a hidden section that shows how to read in the data in the usual way and store it as the 10x_mat -->
...
>>>>>>> 3abcf8f2d15484e03adcef07257ee9e3aca03222
