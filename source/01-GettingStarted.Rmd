...
sample_dirs = list(
  HODay0replicate1 = "inputs/10x_analysis/count_run_HODay0replicate1", 
  HODay0replicate2 = "inputs/10x_analysis/count_run_HODay0replicate2",
  HODay0replicate3 = "inputs/10x_analysis/count_run_HODay0replicate3",
  HODay0replicate4 = "inputs/10x_analysis/count_run_HODay0replicate4",
  HODay7replicate1 = "inputs/10x_analysis/count_run_HODay7replicate1",
  HODay7replicate2 = "inputs/10x_analysis/count_run_HODay7replicate2",
  HODay7replicate3 = "inputs/10x_analysis/count_run_HODay7replicate3",
  HODay7replicate4 = "inputs/10x_analysis/count_run_HODay7replicate4",
  HODay21replicate1 = "inputs/10x_analysis/count_run_HODay21replicate1",
  HODay21replicate2 = "inputs/10x_analysis/count_run_HODay21replicate2",
  HODay21replicate3 = "inputs/10x_analysis/count_run_HODay21replicate3",
  HODay21replicate4 = "inputs/10x_analysis/count_run_HODay21replicate4")
...
write_matrix_dir(mat = geo_mat, dir = '~/ISC_R/bpcells_files')

# What files did that command above create?
as.matrix(list.files('~/ISC_R/bpcells_files'))
      [,1]               
 [1,] "col_names"        
 [2,] "idxptr"           
 [3,] "index_data"       
...
geo_mat = open_matrix_dir(dir = '~/ISC_R/bpcells_files')
geo_so = CreateSeuratObject(counts = geo_mat, min.cells = 1, min.features = 50)
geo_so
