...
In practical terms, PCA creates a reduction that is representative of the overall data while reducing the scale and complexity. For example, we can think of a full single-cell data set as similar to the full Lord of the Rings trilogy - large and complex with quite a bit of detail that might be repeated and isn't necessary to understand the overall plot and make running the analysis prohibitively slow and costly. 
