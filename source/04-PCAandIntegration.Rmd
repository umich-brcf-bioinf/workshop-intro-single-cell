...
![A simple PCA example (from HBC)](./images/curriculum/04-PCAandIntegration/HBC-PCA_2cell_genes.png)
...
![PCA gene loadings (from HBC)](./images/curriculum/04-PCAandIntegration/HBC-PCA_2cell_variation3.png)
...
<table><tr><td>Because the `IntegrateLayers()` function takes a while to run, we will load the RPCA integrated `geo_so` object from a file we have previously generated.</td><td><img src="./images/curriculum/cooking_show-1.png" alt = "Cooking show moment" width="60" height="55"></td></tr></table>
