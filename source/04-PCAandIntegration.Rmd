...
# Elbow plot help visualize how many PCs to include -----------------------
...
```{r, optimal_pcs}
# Function to determine optimal PCs to include ----------------------------
...
# PCA style plot for PC1 and PC2 (unintegrated) --------------------------- 
...
# PCA style plot for PC1 and PC2 (integrated) -----------------------------
