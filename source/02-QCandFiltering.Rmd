...
<table>
	<tr>
	<td>![](./images/curriculum/cooking_show-1.png){width=15%}</td>
	<td>We'll start with a table we created named `phenos.csv` that includes phenotype labels for each sample.</td>
	</tr>
</table>
...
The following code chunk will add columns for `day` and `replicate` to the automatically generated metadata and ensure that certain categorical data appears in correct order, e.g. Day0, Day7, and Day21 instead of Day0, Day21, and Day7.
