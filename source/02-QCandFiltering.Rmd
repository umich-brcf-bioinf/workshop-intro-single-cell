...
The following code chunk will annotated a copy of the metadata with columns for `day` and `replicate` and ensure that certain categorical data appears in correct order, e.g. Day0, Day7, and Day21 instead of Day0, Day21, and Day7. <!--- revised quotes for day since failed in testing on LH -->
...
# Note that column "day" has tick marks in ...factor(`day`,...) because day is also 
