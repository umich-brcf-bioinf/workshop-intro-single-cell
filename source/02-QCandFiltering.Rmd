...
The following code chunk will create new columns for `day` and `replicate`, and ensure that certain categorical data appears in correct order, e.g. Day0, Day7, and Day21 instead of Day0, Day21, and Day7.
