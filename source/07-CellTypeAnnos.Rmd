...
other_markers = c('Sox9', 'Acan', # chondrocyte lineage
                  'Lpl', 'Apoe', # adipocytic genes
                  'Vegfc', 'Sox4', #endothelial & smooth muscle 
                  'Fn1','Dcn', 'Sema3c', # fibroblast specific genes
                  'Acta2', 'Tmem100', # myofibroblast
                  'Col1a1', 'Nes',# skeletal, smooth muscle cells
                  'Cd34','Thy1') #HSPC markers (hematopoetic stem and progenitor)

immune_markers = c('Ly6d', 'Cd19', 'Cd79b', 'Ms4a1', 'Cd22', # Ms4a1=CD20; B-cell markers
                   'Cd14','Adgre1', # macrophage marker
...
## test alternative annotation tool?

# check mitochondrial gene expression - 20% cells seem to be focus in that weird spray of cluster 11
FeaturePlot(geo_so, features='percent.mt')
