...
# - theme() slides the cell type labels be right of the gene symbols
...
# Dotplot will use the data layer and will complain if the data layer is absent,
# so we simply assign the count layer to the data layer.
geo_so@assays$RNA$data = geo_so@assays$RNA$counts
fig1g_rna_dot_plot = DotPlot(geo_so, 
                             features = fig1g_markers,
                             assay = 'RNA',
                             cols = c("lightgrey", "darkgreen"))
fig1h_rna_dot_plot = DotPlot(geo_so,
                             features = fig1h_markers,
                             assay = 'RNA',
                             cols = c("lightgrey", "darkgreen"))
