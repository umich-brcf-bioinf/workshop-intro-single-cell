...
# save to file
ggsave(filename = 'results/figures/immune_markers_sct_dot_plot.png', plot = fig1h_sct_dot_plot, width = 8, height = 6, units = 'in')
...
# Customize annotations - selecting the sub and then subsetting clusters 2,3,4 first before replacing values
celltype_annos$cell_type[c(3,4,5)]  # check selection (& remember cluster 0 is first row)
celltype_annos$cell_type[c(3,4,5)] <- "Dendritic Cell"

# update cluster 7, based on markers
celltype_annos$cell_type[c(8)] <- "Macrophage"
