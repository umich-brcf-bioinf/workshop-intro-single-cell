...
</td></tr><tr><tr class='fig'><td class='fig'>Starting with clustered data and ignoring sample/condition - we can summarize and compare gene expression for known gene markers within each cluster to aid with labeling clusters with the appropriate cell-type or subtype.
</td></tr>
</table>
<br/>
