...
<tr><td class='fig'>![](images/cluster_matrix/pc_res_cluster.png)</td></tr>
<tr><td class='fig'>
...
* You are correct. We need two more tools to validate these are good biological clusters:
...
* We will do both of these in the next sections.
