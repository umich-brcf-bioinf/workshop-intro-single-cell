...
</td></tr><tr><tr class='fig'><td class='fig'>Starting with labeled clustered data and considering sample and/or condition  - compare between case and control within each cluster to identify genes that are impacted by experimental perturbation(s) within that cell-type or subtype.
</td></tr>
</table>
<br/>
