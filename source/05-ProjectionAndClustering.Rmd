...
Before proceeding, we can also check the percentage of mitochondrial genes to determine if there are interesting cell death patterns or indicate further filtering is needed):
