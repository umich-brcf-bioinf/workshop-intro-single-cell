...
<table class='fig'>
<tr class='fig'><td class='fig'>![](images/graphical_abstracts/05-ProjectionAndClustering-Abstract.png)</td></tr>
<tr class='fig'><td class='fig'>Starting with reduced dimensionality data [PCs x cells] for all samples - cells are organized into networks and then split up to into clusters with similar expression programs, regardless of experimental condition.</td></tr>
</table>
<br/>
