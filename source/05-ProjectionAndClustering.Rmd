...
If we look at our object after running these commands, we don't see a change compared to the last time.
...
Observe that we now have a third reduction: `umap.integrated.sct.rpca`.
