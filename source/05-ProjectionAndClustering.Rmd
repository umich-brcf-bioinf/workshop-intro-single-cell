...
Again, in a full analysis workflow, our selection at this step can be more of a starting point for further iterations than a final decision. In the exercises, you'll also have the opportunity to test alternative parameters yourself, including selecting fewer or more PCs. <!-- Also link out to `clusters_faq.Rmd` to show examples? -->
