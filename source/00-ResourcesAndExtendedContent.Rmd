...
<!-- 404? - [Single-cell Analysis - Ouyang Lab](https://ouyanglab.com/singlecell/) - materials last updated in January 2023 -->
- [scRNA-seq workshop - HBC training](https://github.com/hbctraining.github.io/Intro-to-scRNAseq) - lastest release of materials is from March 2023
	- To cite materials from the HBC course, please use: `Mary Piper, Meeta Mistry, Jihe Liu, William Gammerdinger, & Radhika Khetani. (2022, January 6). hbctraining.github.io/Intro-to-scRNAseq: scRNA-seq Lessons from HCBC (first release). Zenodo. [https://doi.org/10.5281/zenodo.5826256](https://doi.org/10.5281/zenodo.5826256)`
...
<!-- 404?- [Ouyang Lab's "Useful resources"](https://ouyanglab.com/singlecell/appendix.html#useful-resources) -->
