...
# We powered down our session and want to rehydrate it
# -------------------------------------------------------------------------
# Load libraries
library(Seurat)
library(BPCells)
...
str(geo_so)
# Here is an example of how to access the RNA assay of a Seurat object
geo_so@assays$RNA
# There are also accessor functions built into Seurat
