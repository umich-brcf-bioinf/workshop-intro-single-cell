...
As we discussed in the workshop, single-cell analysis can be very iterative with the impact of choices made earlier in the analysis not being apparent until later steps and often only being able to evaluate how well those choices reflect the biological context and/or the granularity of our biological question. 
...
<!-- List for now but expect would be better as a table -->
