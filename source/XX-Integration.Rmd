...
E.g. A single integration method might be reported in a paper, but many options may have been tested before finding an approach that sufficient corrects batch effects without removing relevant biological variability.
