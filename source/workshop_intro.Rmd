...
[`r workshop_vars$rstudio_server_url`](`r workshop_vars$rstudio_server_url`){target="blank"}
...
in the __References__ section of each lesson.
  * [Harvard Chan Bioinformatics Core Single-cell RNA-seq data analysis workshop](https://hbctraining.github.io/Intro-to-scRNAseq/){target="_blank"}
...
* Some icons/images were sourced from https://openclipart.org/.
