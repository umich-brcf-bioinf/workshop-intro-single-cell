...
- Determine gene markers for each of the clusters
- Visualize expression across clusters for genes of interest
...
![Comparison of the performance of DE methods applied to scRNA-seq datasets. Methods are ranked by their average performance across all the listed criteria. Image taken from [Soneson and Robinson (2018)](https://pubmed.ncbi.nlm.nih.gov/29481549/)](./images/curriculum/05) <!--- add figure from Ouyang materials-->
...
![](./images/curriculum/05) <!-- file: markers_top_5_sct_dot_plot.png -->
