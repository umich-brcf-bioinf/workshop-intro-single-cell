...
![Image: Comparison of the performance of DE methods applied to scRNA-seq datasets. Methods are ranked by their average performance across all the listed criteria. Image taken from Soneson and Robinson (2018).](./images/curriculum/06-MarkerIdentAndViz/Ouyang_clust-deCompare.png)
...
ggsave(filename = 'results/figures/markers_top_5_sct_dot_plot.png', plot = top_5_sct_dot_plot, width = 12, height = 6, units = 'in') 
```
...
![Figure: Dotplot of top 5 markers per cluster](./images/curriculum/06-MarkerIdentAndViz/markers_top_5_sct_dot_plot.png) 
...
ggsave(filename = 'results/figures/markers_top_5_sct_dot_plot.png', plot = top_5_rna_dot_plot, width = 12, height = 6, units = 'in') 
```
