...
</td></tr><tr><tr class='fig'><td class='fig'>Starting with clustered data and ignoring sample/condition - the gene expression in cells in one cluster is compared to expression in cells from all other clusters to characterize the similarities and differences between clusters and to aid in identifying what cell-types might be present.
</td></tr>
</table>
<br/>
