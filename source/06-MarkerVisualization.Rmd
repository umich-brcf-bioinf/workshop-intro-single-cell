...
<br/>
<img src="images/wayfinder/slides/workshop_isc_wayfinder-MarkerIdentification.png" alt="wayfinder" style="height: 400px;"/>
<br/>
<br/>
...
- How to generate "analytical" cluster markers based on gene expression for *all cells* in that cluster, regardless of treatment group, using `FindAllMarkers()`
- How to visualize the expression of genes of interest, which can aid in cluster identification and labeling, using `Dotplot()`
...
After generating clusters, we need to perform differential expression analysis to identify the genes that distinguish those clusters ([source](https://ouyanglab.com/singlecell/clust.html#identifying-marker-genes)).  This should allow us to answer some key questions for our clusters, as [highlighted by the HBC materials](https://hbctraining.github.io/scRNA-seq_online/lessons/09_merged_SC_marker_identification.html), namely:
...
<!--- consider moving this explaination to the later DE section --->
