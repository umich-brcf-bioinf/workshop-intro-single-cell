...
We can look at how cells load on the first two principal components, similarly to how we often look at samples for bulk RNA-seq, with the `DimPlot` function:
```{r, eval=FALSE}
